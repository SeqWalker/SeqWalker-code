...
from ivlnce_baselines.common.base_il_trainer import BaseVLNCETrainer
            ...
            for dagger_it in range(self.config.IL.DAGGER.iterations):
                ...
                for epoch in tqdm.trange(
                    ...
                    for batch in tqdm.tqdm(
                        ...
                        if observations_batch["instruction"].shape[0] > 3000:
                            print("Batch size exceeds 3000, exiting loop.")
                            continue
                    ...
                    torch.save(self.policy.net.instruction_encoder.llava_model.get_input_embeddings().state_dict(),
                        f"data/checkpoints/embedding{dagger_it * self.config.IL.epochs + epoch}.pth")
